    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="mb-4">
                ...
                <div class="page-title">Edit Flower</div>
            </div>
            ...
            <div class="card p-4">
                ...
                <form action="{{ route('flowers.update', $flower->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="category_id" class="form-select">
                            ...
                            @foreach($categories as $category)
                                <option value="{{ $category->id }}" {{ $flower->category_id == $category->id ? 'selected' : '' }}>
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit" class="btn btn-save">Update Flower</button>
                    </div>
                </form>
            </div>
        </div>
