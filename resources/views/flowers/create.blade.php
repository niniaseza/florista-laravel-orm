...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card p-4">
                <h3 class="page-title mb-4 text-center">🌺 Tambah Bunga Baru</h3>
                ...
                <form action="{{ route('flowers.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control" placeholder="Contoh: Mawar Merah" value="{{ old('nama') }}">
                    </div>
                    <div class="mb-3">
                        <label>Jenis</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="harga" class="form-control" placeholder="Contoh: 25000" value="{{ old('harga') }}">
                    </div>
                    <div class="mb-3">
                        <label>Stok</label>
                        <input type="number" name="stok" class="form-control" placeholder="Contoh: 50" value="{{ old('stok') }}">
                    </div>
                    <div class="mb-4">
                        <label>Deskripsi & Makna Bunga</label>
                        <textarea name="deskripsi" class="form-control" rows="4" placeholder="Tuliskan makna dan deskripsi bunga...">{{ old('deskripsi') }}</textarea>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-simpan px-5">🌸 Simpan Bunga</button>
                    </div>
                </form>
            </div>
        </div>
